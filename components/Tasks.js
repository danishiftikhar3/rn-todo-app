...
const Tasks = ({ navigation, listId }) => {
  ...
  return (
    <View style={styles.container}>
      {data.length > 0 ? <FlatList //if there is data, flatlist will be shown
        data={data}
      ...
      />
        : tasksLoaded ? <Text style={globalStyles.noData}>No tasks in this list</Text> : null // if ther is no data, this line will be shown.
      }
    </View>
  );
};
